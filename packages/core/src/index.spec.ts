...
import { Actions } from '@web3-solid/types'
import { Connector } from '@web3-solid/types'
import { Web3SolidHooks, Web3SolidPriorityHooks, Web3SolidSelectedHooks } from '.'
...
describe('#getSelectedConnector', () => {
  ...
  test('connector2 active', () => {
    act(() => connector2.update({ chainId: 1, accounts: ['0x0000000000000000000000000000000000000000'] }))
    const {
      result: { current: isActive }
    } = renderHook(() => selectedConnectorHooks.useSelectedIsActive(connector))
